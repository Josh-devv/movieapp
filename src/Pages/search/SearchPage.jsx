...
export default function SearchPage() {
   ...
   useEffect(() => {
    ...
    useEffect(() => {
        fetch(`https://api.themoviedb.org/3/discover/movie?api_key=543c959c84a2edaf19d168f7a042f6eb`)
        .then(response => response.json())
                                    ...
                                    <div className="app2">
                                        <Link to={{pathname: `/movie/${week.id}`}} key={week.id}>    
                                            ...
                                            <div className="head-info">
                                                ...
                                                <div className='container-fluid ratings d-flex'>
                                                    <small className="d-flex justify-content-center align-items-center"><IoMdStar size={20} color="yellow" />{week.vote_average}</small>
